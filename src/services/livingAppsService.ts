...
import type { Besitzer, Hunde, Aufenthalte, Buchungsanfragen, CreateBesitzer, CreateHunde, CreateAufenthalte, CreateBuchungsanfragen } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async getHunde(): Promise<Hunde[]> {
    ...
    return enrichLookupFields(records, 'hunde');
  }
  static async getHundeEntry(id: string): Promise<Hunde | undefined> {
    ...
    return enrichLookupFields([record], 'hunde')[0];
  }
  ...
  static async getAufenthalte(): Promise<Aufenthalte[]> {
    ...
    return enrichLookupFields(records, 'aufenthalte');
  }
  static async getAufenthalteEntry(id: string): Promise<Aufenthalte | undefined> {
    ...
    return enrichLookupFields([record], 'aufenthalte')[0];
  }
  ...
  static async getBuchungsanfragen(): Promise<Buchungsanfragen[]> {
    ...
    return enrichLookupFields(records, 'buchungsanfragen');
  }
  static async getBuchungsanfragenEntry(id: string): Promise<Buchungsanfragen | undefined> {
    ...
    return enrichLookupFields([record], 'buchungsanfragen')[0];
  }
