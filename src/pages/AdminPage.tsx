...
const HUNDE_FIELDS = [
  ...
  { key: 'fuetterungshinweise', label: 'Fütterungshinweise', type: 'string/textarea' },
  { key: 'medikamente_besonderheiten', label: 'Medikamente & Besonderheiten', type: 'string/textarea' },
...
const AUFENTHALTE_FIELDS = [
  ...
  { key: 'status', label: 'Status', type: 'lookup/select', options: [{ key: 'geplant', label: 'Geplant' }, { key: 'anwesend', label: 'Anwesend' }, { key: 'abgereist', label: 'Abgereist' }, { key: 'storniert', label: 'Storniert' }] },
  { key: 'herkunft', label: 'Herkunft der Buchung', type: 'lookup/radio', options: [{ key: 'direkt', label: 'Direkte Buchung' }, { key: 'aus_anfrage', label: 'Aus Buchungsanfrage' }] },
  { key: 'preis_euro', label: 'Preis (€)', type: 'number' },
  { key: 'notizen', label: 'Notizen zum Aufenthalt', type: 'string/textarea' },
];
const BUCHUNGSANFRAGEN_FIELDS = [
  { key: 'interessent_vorname', label: 'Vorname', type: 'string/text' },
  { key: 'interessent_nachname', label: 'Nachname', type: 'string/text' },
  { key: 'interessent_telefon', label: 'Telefonnummer', type: 'string/tel' },
  { key: 'interessent_email', label: 'E-Mail-Adresse', type: 'string/email' },
  ...
  { key: 'status', label: 'Status der Anfrage', type: 'lookup/select', options: [{ key: 'offen', label: 'Offen' }, { key: 'bestaetigt', label: 'Bestätigt' }, { key: 'abgelehnt', label: 'Abgelehnt' }, { key: 'abgelaufen', label: 'Abgelaufen' }] },
