...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    { row: ['interessent_vorname', 'interessent_nachname'], cols: '1fr 1fr' },
    'interessent_telefon',
    'interessent_email',
    'hund_name',
    'hund_rasse',
  ...
  computed: {
    '_buchungsanfrage_wunsch_dauer_nächte': { kind: 'dateDiff', from: 'wunsch_anreise', to: 'wunsch_abreise', unit: 'days' },
  },
};
