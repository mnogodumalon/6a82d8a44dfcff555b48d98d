...
// <custom:intent-imports>
import { IconCalendarPlus, IconClipboardCheck, IconSparkles } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 3 Schritten anlegen: Besitzer, Hund und Aufenthalt' },
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bestätigen', en: 'Confirm request' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage prüfen und direkt in einen Aufenthalt umwandeln' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconSparkles, description: 'KI-generiertes individuelles Porträt für einen Hund erstellen und speichern' },
  // </custom:intents>
];
