...
// <custom:intent-imports>
import { IconCalendarPlus, IconClipboardCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anfrage-bearbeiten', label: { de: 'Anfrage bearbeiten', en: 'Process inquiry' }, icon: IconClipboardCheck, description: 'Offene Buchungsanfrage prüfen und bestätigen oder ablehnen' },
  // </custom:intents>
];
