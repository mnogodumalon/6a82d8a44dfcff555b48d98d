  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'besitzer': (
      <div key="besitzer" className="space-y-1.5">
        ...
        <Combobox
          id="besitzer"
          placeholder="Besitzer der Anfrage"
    ...
    'platznummer': (
      <div key="platznummer" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="platznummer" className="max-sm:h-11"><SelectValue placeholder="Welcher Platz?" /></SelectTrigger>
          <SelectContent>
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besondere Wünsche, Verhalten, Fütterung..."
